...
import { Navbar } from '../Header/Heder'
    ...
    <div className="relative w-full">
      <div className="relative isolate z-0 bg-white px-6 pt-14 lg:px-8">
        <div className="relative mx-auto max-w-2xl py-24">
          <div className="absolute inset-x-0 top-5 -z-50 transform-gpu overflow-hidden blur-3xl md:top-[-6rem]">
            <svg
...
globe,and equip them to fulfill their unique purpose.
            ...
            <div className="mt-10 flex items-center justify-center gap-x-2">
              ...
              {<SecondaryButton ButtonText={"know About Us"} onClickEvent={navigate} path={"About"}/>}
